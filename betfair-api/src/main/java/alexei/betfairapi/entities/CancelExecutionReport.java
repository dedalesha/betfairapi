...
public class CancelExecutionReport {
	...
	/**
	  * 
	  */
	public java.util.List<CancelInstructionReport> getInstructionReports() {
	...
	/**
	  * 
	  */
	public void setInstructionReports(java.util.List<CancelInstructionReport> instructionReports) {
